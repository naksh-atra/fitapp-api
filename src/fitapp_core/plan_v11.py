...
def _canon_from_evidence_rules(inputs: InputsV11, hits: List[Dict[str, Any]]) -> Optional[List[Dict[str, Any]]]:
    ...
    equip_list = (inputs.equipment or []) if isinstance(inputs.equipment, list) else (inputs.equipment or [])
    def main_item(mv, s, r, cue=None, rest=None, notes=""):
        return {"movement": mv, "main_focus": None, "intensity_cue": cue, "sets": s, "reps": r, "tempo_or_rest": rest, "notes": notes}
    def acc_item(mv, s, r, cue=None, rest=None, notes=""):
        return {"movement": mv, "sets": s, "reps": r, "intensity_cue": cue, "tempo_or_rest": rest, "notes": notes}

    # Very simple, research-aligned guardrails by goal:
    # - Hypertrophy: 8–20 reps range with 10–15 total sets per large muscle per week, split over 4–5 days.
    # - Strength: 3–6 reps for mains, 6–10 for accessories, 3–4 days.
    # - Endurance: cardio focus with Zone 2 base; resistance minimal.
    # - Fat loss: moderate reps, accessory density, light cardio on 2 days.
    days: List[Dict[str, Any]] = []
    ...
    if goal == "strength":
        template = [
            ("Mon", main_item("Back Squat", 3, 5, cue="RPE 7–9", rest="120–180s"), [acc_item("Leg Press", 3, 8, rest="90–120s"), acc_item("Hamstring Curl", 3, 10, rest="60–90s")]),
            ("Tue", main_item("Bench Press", 4, 3, cue="RPE 7–9", rest="120–180s"), [acc_item("DB Row", 3, 8, rest="90–120s"), acc_item("Triceps Pushdown", 3, 10, rest="60–90s")]),
            ("Thu", main_item("Deadlift", 3, 3, cue="RPE 7–9", rest="180–240s"), [acc_item("Back Extension", 3, 10, rest="60–90s"), acc_item("Plank", 3, 30, notes="seconds")]),
            ("Fri", main_item("Overhead Press", 3, 5, cue="RPE 7–9", rest="120–180s"), [acc_item("Lat Pulldown", 3, 10, rest="60–90s"), acc_item("Lateral Raise", 3, 12, rest="45–75s")]),
        ]
        for name, main, acc in template[:dpw]:
            days.append({"day": name, "day_name": name, "main": [main], "accessory": acc, "prehab": [], "cardio_notes": []})
        return days
    ...
    if goal == "fat_loss":
        template = [
            ("Mon", main_item("Back Squat", 3, 8, cue="RPE 6–8", rest="90–120s"), [acc_item("Leg Press", 3, 12, rest="60–90s"), acc_item("Calf Raise", 3, 15, rest="45–75s")], [{"movement": "Zone 2 Cardio", "duration":"20–30 min","tempo_or_rest":"Zone 2","notes":""}]),
            ("Tue", main_item("Bench Press", 3, 8, cue="RPE 6–8", rest="90–120s"), [acc_item("DB Row", 3, 12, rest="60–90s"), acc_item("Face Pull", 3, 15, rest="45–75s")], []),
            ("Thu", main_item("Romanian Deadlift", 3, 8, cue="RPE 6–8", rest="90–120s"), [acc_item("Hamstring Curl", 3, 12, rest="60–90s"), acc_item("Reverse Lunge", 3, 10, rest="60–90s")], [{"movement": "Zone 2 Cardio", "duration":"20–30 min","tempo_or_rest":"Zone 2","notes":""}]),
            ("Fri", main_item("Overhead Press", 3, 8, cue="RPE 6–8", rest="90–120s"), [acc_item("Lat Pulldown", 3, 12, rest="60–90s"), acc_item("Biceps Curl", 3, 12, rest="60–90s")], []),
        ]
        for name, main, acc, cardio in template[:dpw]:
            days.append({"day": name, "day_name": name, "main": [main], "accessory": acc, "prehab": [], "cardio_notes": cardio})
        return days

    # Hypertrophy default via evidence rules
    template = [
        ("Mon", main_item("Bench Press", 3, 6, cue="RPE 7–9", rest="90–120s"),
         [acc_item("Incline DB Press", 3, 10, rest="60–90s"), acc_item("Lateral Raise", 3, 15, rest="45–75s"), acc_item("Triceps Pushdown", 3, 12, rest="60–90s")]),
        ("Tue", main_item("Back Squat", 3, 6, cue="RPE 7–9", rest="120–180s"),
         [acc_item("Leg Press", 3, 12, rest="60–90s"), acc_item("Leg Curl", 3, 12, rest="60–90s"), acc_item("Calf Raise", 3, 15, rest="45–75s")]),
        ("Wed", main_item("Barbell Row", 3, 6, cue="RPE 7–9", rest="90–120s"),
         [acc_item("Lat Pulldown", 3, 10, rest="60–90s"), acc_item("Rear Delt Fly", 3, 15, rest="45–75s"), acc_item("Biceps Curl", 3, 12, rest="60–90s")]),
        ("Thu", main_item("Romanian Deadlift", 3, 6, cue="RPE 7–9", rest="120–180s"),
         [acc_item("Split Squat", 3, 10, rest="60–90s"), acc_item("Hamstring Curl", 3, 12, rest="60–90s"), acc_item("Back Extension", 3, 12, rest="60–90s")]),
        ("Fri", main_item("Overhead Press", 3, 6, cue="RPE 7–9", rest="90–120s"),
         [acc_item("DB Row", 3, 10, rest="60–90s"), acc_item("Face Pull", 3, 15, rest="45–75s"), acc_item("Cable Fly", 3, 12, rest="60–90s")]),
    ]
    for name, main, acc in template[:dpw]:
        days.append({"day": name, "day_name": name, "main": [main], "accessory": acc, "prehab": [], "cardio_notes": []})
    return days
